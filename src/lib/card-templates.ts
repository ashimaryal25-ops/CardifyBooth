export const cardTemplates = [
  ...
  },
  {
    ...
    fitSummary:
      "The rarest, most powerful card. Reserved ONLY for the strongest students who max out campus contribution (Legendary or Campus Myth, Campus Power around 90+). Premium gold finish.",
    keywords: [
      "award",
      "achieve",
      "achievement",
...
const TOP_RARITIES = new Set(["Legendary", "Campus Myth"]);
